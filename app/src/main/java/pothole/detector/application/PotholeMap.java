...
public class PotholeMap extends AppCompatActivity
    implements
        Serializable,
        OnMapReadyCallback,
...
{
    private static final String TAG = PotholeMap.class.getSimpleName();
    ...
    //GoogleApiClient variable for the entry point
    ...
    /* * * * *
    * The following methods are abstract methods for GoogleMaps class
     * * * * */
    @Override
    ...
    /* * * * *
     * The following methods are marking the Google Map
     * * * * */
    ...
    /* * * * *
     * The following methods are abstract methods for GoogleApiClient class
     * * * * */
    ...
    protected void onStart() {
        super.onStart();
        // connect to client when activity starts
    ...
    /* * * * *
     * The following methods are abstract methods for Location Listener class
     * * * * */
    ...
    /* * * * *
     * The following methods are abstract methods for creating a Geofence
     * * * * */
